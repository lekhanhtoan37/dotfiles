...
function M.create_module_commands(module_name, commands)
  for command_name, def in pairs(commands) do
    ...
    table.insert(parts, string.format("lua require'nvim_lsp'[%q].commands[%q][1](<f-args>)", module_name, command_name))
...
function M.format_vspackage_url(extension_name)
  ...
  return string.format(
    "https://marketplace.visualstudio.com/_apis/public/gallery/publishers/%s/vsextensions/%s/latest/vspackage",
    org,
    package
  )
end
